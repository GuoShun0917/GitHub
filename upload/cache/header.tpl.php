...
</a><a href="<?php echo $this->_tpl_vars['url']['register']; ?>
"><?php echo $this->_tpl_vars['lang']['user_register_nav']; ?>
</a> 
   <?php endif; ?> 
   <a href="<?php echo $this->_tpl_vars['url']['cart']; ?>
" class="cart"><?php echo $this->_tpl_vars['lang']['order_cart']; ?>
<span class="cartTotal"><span><?php echo $this->_tpl_vars['cart_total']; ?>
</span></span></a>
  </ul>
  <?php endif; ?>
 </div>
...
"><img src="http://47.107.251.202:5210/theme/shop/images/<?php echo $this->_tpl_vars['site']['site_logo']; ?>
...
" autocomplete="off" maxlength="128" value="<?php if ($this->_tpl_vars['keyword']): ?><?php echo $this->smarty_modifier_escape($this->_tpl_vars['keyword']); ?>
...
?> 
   <?php if ($this->_foreach['nav_middle_list']['iteration'] <= 5): ?>
